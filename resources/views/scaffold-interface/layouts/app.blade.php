			...
			<header class="main-header">
				...
				<nav class="navbar navbar-static-top">
					...
					<a href="#" class="sidebar-toggle" data-toggle="offcanvas" role="button">
						<span class="sr-only">Tablero navegación</span>
					</a>
						...
						<ul class="nav navbar-nav">
							...
							<li class="dropdown notifications-menu">
								<a href="#" class="dropdown-toggle" data-toggle="dropdown">
									...
									<span class="label notification-label">Nuevo</span>
								</a>
					...
					<ul class="sidebar-menu">
						...
						<li class="active treeview">
							<a href="{{url('dashboard')}}">
								<i class="fa fa-dashboard"></i> <span>Panel</span></i>
							</a>
						</li>
						<li class="header">ADMINISTRADOR</li>
						<li class="treeview"><a href="{{url('/users')}}"><i class="fa fa-users"></i> <span>Usuario</span></a></li>
						<li class="treeview"><a href="{{url('/roles')}}"><i class="fa fa-user-plus"></i> <span>Rol</span></a></li>
